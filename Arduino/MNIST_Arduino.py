...
## THIS IS THE 'SECOND PART', here is where the code for the webcam and arduino serial is 
# Initialize the Arduino port code:
serialInst = serial.Serial()
serialInst.baudrate = 9600
serialInst.port = "COM5" # Change to the port being used
serialInst.open()
...
while True:
    ...
    serialInst.write(f"{prediction}\n".encode('utf-8')) # Gives prediction to Arduino in the form of a string
    # 5.show the frame
